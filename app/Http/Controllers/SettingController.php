...
class SettingController extends Controller
{
    ...
    public function index()
    {
        ...
        $ar_price = $en_price = [];
        $ar_international_flights_cost = $en_international_flights_cost = [];
        foreach ($settings as $record) {
            if (strpos($record->key, 'en_') === 0) {
                ...
                if (strpos($record->key, 'international_flights_cost')) $en_international_flights_cost = $record;
            ...
            if (strpos($record->key, 'ar_') === 0) {
                ...
                if (strpos($record->key, 'international_flights_cost')) $ar_international_flights_cost = $record;
        ...
        return view('settings', compact(
            ...
            'ar_international_flights_cost',
            'en_international_flights_cost',
