                                ...
                                <div class="col-12">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select type="text" name="country" class="form-select @error('country') is-invalid @enderror" id="select-countries">
                                            ...
                                            <option value="{{ $country->code }}" @if($country->code == $hotel->country) selected @endif data-custom-properties=" &lt;span class=&quot;flag flag-xs flag-country-{{ $country->code }}&quot;&gt;&lt;/span&gt;">{{ $country->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('country')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select type="text" name="city" class="form-select @error('city') is-invalid @enderror">
                                            ...
                                            <option @if($city->id == $hotel->city) selected @endif value="{{ $city->id }}">{{ $city->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('city')
                                        <div class="invalid-feedback">{{ $message }}</div>
