@extends('layouts.app')
@section('tabTitle', __("view.addReservation"))
@section('content')
<div class="wrapper">
    <div class="page-wrapper">
        ...
        <div class="page-body">
            <form action="{{ route('reservation.store') }}" method="POST" data-form class="card">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="flight_id" class="form-select @error('flight_id') is-invalid @enderror" id="select_flight">
                                            ...
                                            <option value="{{ $flight->flight_id }}" @if($flight->flight_id == old('flight_id')) selected @endif>{{ $flight->flight_id }}</option>
                                            @endforeach -->
                                        </select>
                                        @error('flight_id')
                                        <div class="invalid-feedback">{{ $message }}</div>
