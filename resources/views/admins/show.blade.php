@extends('layouts.app')
@section('tabTitle', __("view.admins"))
@section('content')
<div class="col-12">
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h3 class="card-title">{{ __('view.admins') }}</h3>
            <a href="{{ route('admin.add') }}" class="btn btn-facebook btn-sm">
        ...
        <form action="{{ route('admin.filter') }}" method="POST" id="form">
            @csrf
        ...
        <div class="table-responsive">
            <table class="table card-table table-vcenter text-nowrap datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><span class="text-muted">{{ $admin->id }}</span></td>
                        <td>{{ $admin->name }}</td>
                        <td>{{ $admin->email }}</td>
                        <td>
                            <span class="dropdown">
